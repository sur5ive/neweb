(function($) {
	...
	var layerSlider = function(el, options) {
		...
		ls.imgPreload = function(layer,callback){
			...
			if( ls.o.imgPreload ){
				...
				// layer bg
				// && layer.css('background-image').indexOf('url') != -1 
				if( layer.css('background-image') != 'none'){
	...
	layerSlider.options = {
		...
		skinsPath			: '/skins/',				// You can change the default path of the skins folder. Note, that you must use the slash at the end of the path.
